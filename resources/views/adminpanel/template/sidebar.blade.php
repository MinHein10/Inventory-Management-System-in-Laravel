...
<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
      ...
      <ul class="sidebar-menu">
        <li class="menu-header"> Hello {{ Auth::user()->name }} </li>
    ...
    <li class="dropdown">
      <a href="#" class="menu-toggle nav-link has-dropdown"><i class="material-icons">redeem</i><span>Product Management</span></a>
      ...
      <li class="dropdown">
        <a href="#" class="menu-toggle nav-link has-dropdown"><i class="material-icons">compare_arrows</i><span>Stock Management</span></a>
        <ul class="dropdown-menu">
        <li><a href="{{route('stockin.index')}}">Stock In (Purchase)</a></li>
        <li><a href="{{route('stockout.index')}}">Stock Out (Sale)</a></li>
        ...
        <li class="dropdown">
          ...
          <li><a href="{{route('home')}}">Login</a></li>
            <li><a href="auth-register.html">Register</a></li> 
            {{-- <li><a href="{{route('admin.usermanagement')}}">User Management2</a></li> --}}
        ...
        <li class="dropdown">
          ...
          <li><a class="nav-link" href="{{route('admin.blog')}}">Blog</a></li>
          <li><a class="nav-link" href="{{route('portfoliopage')}}">Domestic Products</a></li>
          </ul>
        </li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="nav-link" href="{{route('profilepage')}}">Profile</a></li>
            <li><a class="nav-link" href="{{route('contactpage')}}">Contact</a></li>
        ...
        <a href="{{route('customer.index')}}" class="nav-link text-red"><i class="material-icons">account_circle</i><span>Customer</span></a>
        ...
        <a href="{{route('logout')}}" class="nav-link text-danger"><i class="fas fa-sign-out-alt"></i><span>Logout</span></a>
